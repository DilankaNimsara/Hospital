...
//        Barcode_Image.createImage("chillyfacts.png", "dilanka nimsara");
...
//    }
    ...
    public static void createImage(String image_name, String myString) {
        try {
            ...
            canvas.finish();
            //write to png file
            FileOutputStream fos = new FileOutputStream("C:\\Users\\ASUS\\Documents\\NetBeansProjects\\Hospital\\src\\images\\" + image_name);
